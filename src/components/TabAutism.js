...
const TabAutism = () => {
        ...
        datasets: [
            {
                ...
                data: [scorestd.autism_dscore, avg, maxVal, minVal]
            },

            {
                ...
                data: [scorestd.autism_tscore, avg5, maxVal5, minVal5]
            },
    ...
    const minVal4 = Math.min(...scoreyear.map(item => item.autism_group))

    const maxVal4 = Math.max(...scoreyear.map(item => item.autism_group));
    ...
    const data3 = {
        ...
        datasets: [

            {
                ...
                data: [scorestd.autism_group, avg4, maxVal4, minVal4]
            },
        ],
    };
        ...
        <div className="alltab-bg">
            {adhddata === null ? <div style={{ textAlign: "center" }}>ไม่พบข้อมูลการประเมินนักเรียน</div> : (
                <div>
                    ...
                    <h5 style={{ textAlign: "center" }}>พฤติกรรมภาวะออทิซึม (KUS-SI Rating Scale 5: Autism/ PDDs) </h5> <br />
                        ...
                        <div>
                            <div style={{ display: "flex" }}>
                                <Row style={{ backgroundColor: "whitesmoke", padding: "20px 35px 40px 35px", borderRadius: "20px", boxShadow: "1px 2px 2px 0px rgb(158, 158, 158)", width: "50%", marginRight: "30px" }}>
                                    ...
                                    <h6 style={{ textAlign: "center" }}>ด้านออทิซึม</h6> <br />
                                    <Line data={data} />
                                ...
                                <Row style={{ backgroundColor: "whitesmoke", padding: "40px 35px 40px 35px", borderRadius: "20px", boxShadow: "1px 2px 2px 0px rgb(158, 158, 158)", width: "50%" }}>
                                    <h5 style={{ textAlign: "center" }}>ปีการศึกษา {schoolyear2} / {term2}</h5> <br />
                                    <h6 style={{ textAlign: "center" }}>กลุ่ม ด้านออทิซึม</h6> <br />
                                    <Bar data={data3} />
                                </Row>
                            </div>
